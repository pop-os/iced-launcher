# Cosmic Application Template (WIP)
...
- [Gtk Rust Template](https://gitlab.gnome.org/World/Rust/gtk-rust-template/-/tree/master/) is what this project's template is directly built on top of.
